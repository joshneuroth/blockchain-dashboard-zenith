...
import BlockActivityChart from './BlockActivityChart';
        ...
        <>
          ...
          {lastBlock && providers && Object.keys(providers).length > 0 && (
            <div className="mt-1 flex items-center">
              <div className="bg-gray-100 dark:bg-gray-800 text-xs px-2 py-1 rounded flex items-center">
                <span className="font-medium mr-1">{lastBlock.provider}</span>
